...
ブラウザ画面では、標準3対3の戦闘を1行動ずつ実行できます。`AUTO開始`、`一時停止`、`1行動進める`、`×1 / ×2 / ×4`、`次の味方を手動`、`リセット`はマウスとタッチの両方で操作できます。手動割込では固有・汎用・開花・移動・待機から行動と対象を選び、障壁・肩代わり・AoE・状態・強制移動・次回順位を確認してから確定します。
...
- Phase 4 T029の盤面強化・未来12件タイムライン・AI理由詳細表示：完了
- Phase 4 T030の固有/汎用/開花/移動/待機選択・対象指定・確定前解決プレビュー：完了
